      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {projects.map((project) => (
            <div
              key={project.title}
              className="glass-card overflow-hidden shadow-card card-hover group"
            >
              {/* Header with gradient */}
              <div className="h-40 bg-gradient-to-br from-primary/20 via-accent/10 to-secondary/20 p-6 flex items-end relative overflow-hidden">
